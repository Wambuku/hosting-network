...
<head>
	...
	<title>Local Network Service Search Engine|| Home Page</title>
			...
			<div class="fullwidthbanner-container">
				<div class="revolution-slider tx-center">
					<ul><!-- SLIDE  -->
						...
						<!-- MAIN IMAGE -->
							<img src="images/banner3.jpg" alt="item slide">
						<!-- LAYERS -->	
					...
					<form class="clearfix" name="search" action="serviceman-search.php" method="post">
						...
						<div class="select-field-wrap pull-left">
							<select class="search-form-select" name="categories" >
								<option class="options" value="all-categories">Zuku</option>
								<option class="options" value="all-categories"> Faiba</option>
								<option class="options" value="all-categories"> Telkom</option>
								<option class="options" value="all-categories">Safaricom</option>
								<option class="options" value="all-categories">Airtel</option>
								<?php 

$sql2 = "SELECT * from  Network Category ";
				...
				<div class="row category-section-wrap cat-style-2">
					<div class="col-md-12 col-sm-6 col-xs-12"><!-- category column -->
						<div class="cat-wrap shadow-1">
							...
							<h5><i class="fa fa-heart bgblue-1 white"></i>Local Network Service Category </h5>
							<div class="cat-list-wrap">
								<ul class="cat-list">
									<?php
$sql="SELECT Category, count(ID) as total from Attendant group by Category";

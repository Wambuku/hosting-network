...
$sql="update Attendant set Category=:cat,Name=:name,MobileNumber=:mobilenumber,Address=:address,City=:city where ID=:eid";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <?php
                   $eid=$_GET['editid'];
$sql="SELECT * from Attendant where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
